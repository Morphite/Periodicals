...
public class ConnectionPool {
     ...
     */
    private ArrayBlockingQueue<OwnConnection> connectionQueue;

    private static final String RESOURCE_PATH = "/resources/database.properties";
    ...
    public void destroy() throws ConnectionPoolException {
        int count = 0;
        for (OwnConnection connection : connectionQueue) {
            try {
        ...
        LOG.info(count + " - сonnections was closed.");
    }
    ...
    private void makeConnection(final int POOL_SIZE) throws IOException, ClassNotFoundException, SQLException {
        ...
        properties.load(getClass().getClassLoader().getResourceAsStream(RESOURCE_PATH));
        connectionQueue = new ArrayBlockingQueue<>(POOL_SIZE);
        Class.forName(properties.getProperty(DRIVER_NAME));
        for (int i = 0; i < POOL_SIZE; i++) {
            OwnConnection connection = new OwnConnection(DriverManager.getConnection(properties.getProperty(CONNECTION_STRING), properties));
     ...
     */
    private void closeConnection(OwnConnection connection) {
        connectionQueue.offer(connection);
    }

    /**
     * The Inner Class OwnConnection.
     */
